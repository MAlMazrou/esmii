...
install -d -m 0755 /usr/local/libexec/esmii "${SHARE_ROOT}" "${SHARE_ROOT}/caddy/sites" "${SHARE_ROOT}/postgres" "${SHARE_ROOT}/valkey" "${SHARE_ROOT}/stalwart" "${SHARE_ROOT}/production-pull" "${SHARE_ROOT}/templates"
...
install -m 0644 "${REPOSITORY_ROOT}/infra/templates/compose.production.external.yaml" "${SHARE_ROOT}/templates/compose.production.external.yaml"
